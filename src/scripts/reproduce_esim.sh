...
#python src/scripts/train_eval/train_esim.py wiki results/kim_wiki_fq_12_q/ --embedding_name=kim_wiki_fq_12_q
#python src/scripts/train_eval/train_esim.py wiki results/kim_wiki_fq_2_q/ --embedding_name=kim_wiki_fq_2_q
#python src/scripts/train_eval/train_esim.py wiki results/kim_wiki_fq_12/ --embedding_name=kim_wiki_fq_12
#python src/scripts/train_eval/train_esim.py wiki results/kim_wiki_fq_2/ --embedding_name=kim_wiki_fq_2
#python src/scripts/train_eval/train_esim.py wiki results/kim_fq_12/ --embedding_name=kim_fq_12
#python src/scripts/train_eval/train_esim.py wiki results/kim_fq_2/ --embedding_name=kim_fq_2
#python src/scripts/train_eval/evaluate_esim.py --model-name kim_wiki_fq_12_q
#python src/scripts/train_eval/evaluate_esim.py --model-name kim_wiki_fq_2_q
#python src/scripts/train_eval/evaluate_esim.py --model-name kim_wiki_fq_12
#python src/scripts/train_eval/evaluate_esim.py --model-name kim_wiki_fq_2
#python src/scripts/train_eval/evaluate_esim.py --model-name kim_fq_12
#python src/scripts/train_eval/evaluate_esim.py --model-name kim_fq_2
...
python src/scripts/train_eval/train_esim.py wiki results/cokim_wiki_fq_12_q/ --embedding_name=cokim_wiki_fq_12_q
#python src/scripts/train_eval/train_esim.py wiki results/cokim_wiki_fq_2_q/ --embedding_name=cokim_wiki_fq_2_q
python src/scripts/train_eval/train_esim.py wiki results/cokim_wiki_fq_12/ --embedding_name=cokim_wiki_fq_12
#python src/scripts/train_eval/train_esim.py wiki results/cokim_wiki_fq_2/ --embedding_name=cokim_wiki_fq_2
#python src/scripts/train_eval/train_esim.py wiki results/cokim_fq_12/ --embedding_name=cokim_fq_12
#python src/scripts/train_eval/train_esim.py wiki results/cokim_fq_2/ --embedding_name=cokim_fq_2
python src/scripts/train_eval/evaluate_esim.py --model-name cokim_wiki_fq_12_q
#python src/scripts/train_eval/evaluate_esim.py --model-name cokim_wiki_fq_2_q
python src/scripts/train_eval/evaluate_esim.py --model-name cokim_wiki_fq_12
#python src/scripts/train_eval/evaluate_esim.py --model-name cokim_wiki_fq_2
#python src/scripts/train_eval/evaluate_esim.py --model-name cokim_fq_12
#python src/scripts/train_eval/evaluate_esim.py --model-name cokim_fq_2
