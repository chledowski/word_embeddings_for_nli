...
declare -a NAMES=(
    "knowledge_after_lstm_${EMBEDDING}_both_al0.0_dot_frac${FRAC}"
    "knowledge_after_lstm_${EMBEDDING}_both_al0.1_dot_frac${FRAC}"
    "knowledge_after_lstm_${EMBEDDING}_both_al1.0_dot_frac${FRAC}"
    "knowledge_after_lstm_${EMBEDDING}_both_al5.0_dot_frac${FRAC}"

    "knowledge_after_lstm_${EMBEDDING}_al0.1_dot_frac${FRAC}"
    "knowledge_after_lstm_${EMBEDDING}_al1.0_dot_frac${FRAC}"
    "knowledge_after_lstm_${EMBEDDING}_al5.0_dot_frac${FRAC}"
)
