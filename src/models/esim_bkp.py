...
def esim(config, data):
    ...
    a = Input(shape=(config['sentence_max_length'],), dtype='int32', name='premise')
    b = Input(shape=(config['sentence_max_length'],), dtype='int32', name='hypothesis')
    ...
    m_a, m_b = LocalInferenceLayer()([encoded_a, encoded_b], config["dropout"])
